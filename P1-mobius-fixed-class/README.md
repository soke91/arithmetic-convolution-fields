# P1-mobius-fixed-class reproduction packet

Purpose: canonical working and public packet for `P1-mobius-fixed-class.tex`.
...
contains 12 Python files and 12 committed result files. Files
