...
%
%  NOT the canonical manuscript.  This is the unsorted version: the
%  earlier draft, kept beside the canonical one as its record.
%  P2-no-go-divisor-switch.tex is the canonical manuscript.
%
